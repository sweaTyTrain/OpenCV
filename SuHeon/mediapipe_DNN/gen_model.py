...
gen_model_module.DNN_2D_angle(train_route, model_save_route, test_base_route, False)
...
# model_save_route = '../models/dnn_model_3D_point.h5'
#
# gen_model_module.DNN_3D_point(train_route, model_save_route, test_base_route, False)
