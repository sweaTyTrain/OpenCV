...
model = tf.keras.models.load_model('models/model_ver2.h5')
...
while video.isOpened():
    ...
    pre = model.predict(np.array([[back_angle_left, back_angle_right, knee_angle_left, knee_angle_right]]))
    ...
    # pre 화면에 출력
    cv2.putText(frame, f"predict: {pre[0][0]:.4f}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    print("predict:", pre[0][0])
